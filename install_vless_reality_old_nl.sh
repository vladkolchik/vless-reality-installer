...
# 
# Использование:
# bash <(curl -s https://raw.githubusercontent.com/vladkolchik/vless-reality-installer/refs/heads/main/install_vless_reality_old_nl.sh)
...
check_root() {
    if [[ $EUID -ne 0 ]]; then
        ...
        print_status "Попробуйте: sudo bash <(curl -s https://raw.githubusercontent.com/vladkolchik/vless-reality-installer/refs/heads/main/install_vless_reality_old_nl.sh)"
        exit 1
    fi
}
...
generate_config() {
    ...
    DEST_SITES=("nu.nl" "microsoft.com" "cloudflare.com" "discord.com" "apple.com")
